	...
	furantur: {
        ...
        condition: {
            ...
            onResidual(pokemon) {
				...
				this.heal(pokemon.baseMaxhp / (pokemon.hasType(['Ghost', 'Psychic']) ? 16 : 32));
            },
            onEnd(pokemon) {
        ...
        shortDesc: "Deals 1/16 max HP each turn; 1/8 on Ghost, Psychic.",
    },
    risingdragon: {
		num: 2500,
        accuracy: 100,
        ...
        target: "normal",
        type: "Fighting",
        desc: "Hits 3 times, 3rd hit always crits.",
        shortDesc: "Hits 3 times, 3rd hit always crits.",
    },
    lightningelbow: {
		num: 2501,
        accuracy: 100,
